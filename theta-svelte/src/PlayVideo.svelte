...
<script lang="ts">
  ...
  const accounts = ThetaWalletConnect.requestAccounts();
  // --------- Guest User Helpers ------------
  /*
  ...
  */
  ...
  function startApp() {
    ...
    widget.setMainMessage(
      "Welcome to the Sample Integration. Help us test blockchain video sharing and earn TFUEL."
    );
...
<main>
  ...
  <vm-player id="player" controls>
    <vm-hls libSrc="https://d1ktbyo67sh8fw.cloudfront.net/js/theta-hls-plugin.umd.js" poster="/media/poster.png">
