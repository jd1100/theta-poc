<svelte:options tag="play-video-test" />
<svelte:head>
...
<script lang="ts">
    ...
    import Hls from "./theta/hls.js"
    import "./theta/theta-hls-plugin.js"
    ...
    import Theta from "./theta/theta.js"
    console.log({ url });
    ///////////////////
    var player
    var hlsPlayer
    ...
    console.log(Theta.HlsJsFragmentLoader)
    // Event handlers
